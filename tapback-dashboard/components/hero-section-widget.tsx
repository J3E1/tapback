...
const bgColors = ['270, 79%, 95%', '25, 95%, 95%', '43, 96%, 95%', '0, 72%, 95%', '226, 71%, 95%'];
const primaryColors = [
...
export default function HeroSectionWidget({ submitLayout = false }: { submitLayout?: boolean }) {
	...
	return (
		<div style={containerStyle}>
			<Widget submitLayout={submitLayout} />
		</div>
	);
}
